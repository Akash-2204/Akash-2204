### 👋 About Me: Akash Thirumuruganantham

🚀 **Full-Stack Developer | Tech Enthusiast | Digital Experience Crafter**
...
- **Building Scalable Systems:** I specialize in leveraging modern technologies like React, Next.js, React Native, Node.js, and GraphQL to create seamless, performance-driven digital experiences.
  
- **Designing Intuitive UIs:** I focus on creating user interfaces that are not only visually appealing but also WCAG-compliant and accessible, using tools like Storybook, Figma, and clean design principles.

- **Cloud-Powered Solutions:** With AWS (Lambda, S3, CloudFront), I ensure that my applications scale securely and efficiently.

- **Streamlining Deployments:** Automation is key! I use tools like Jenkins, GitHub Actions, and Docker to build reliable CI/CD pipelines, ensuring seamless and fast deployments.

- **Optimizing Performance:** With technologies like Redis, MongoDB, and performance tuning, I reduce load times and optimize user experiences by up to 40%.

---

### 🏆 **My Superpowers:**

- **Problem-Solving:** I love transforming complex challenges into clean, elegant solutions.
...
- When I’m not coding, I’m on the field playing **volleyball**, **pickleball**, or **soccer**—teamwork and energy are key both on and off the screen!
  
- I’m a **culture and cuisine explorer**, always excited to discover new flavors and experiences.
  
- I love challenges, whether it’s solving a tricky tech problem or diving into a new tech stack.

---

### 📫 **Let’s Connect:**

Feel free to reach out to explore exciting projects, collaborate, or just say hi! 🚀
...
<!-- Displaying overall GitHub stats with a shadow blue theme 
![](https://github-readme-stats.vercel.app/api?username=Akash-2204&theme=shadow_blue&hide_border=true&include_all_commits=false&count_private=false)<br/>

 Displaying the current GitHub streak stats with a shadow blue theme 
![](https://github-readme-streak-stats.herokuapp.com/?user=Akash-2204&theme=shadow_blue&hide_border=true)<br/>

 Displaying top languages used in my GitHub repositories with a compact layout 
![](https://github-readme-stats.vercel.app/api/top-langs/?username=Akash-2204&theme=shadow_blue&hide_border=true&include_all_commits=false&count_private=false&layout=compact) -->
